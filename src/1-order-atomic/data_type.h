...
public:
    Cache(int s)
    {
        ...
        hidden_input[0] = vector<vector<MatrixXd> >(s, vector<MatrixXd>(s, MatrixXd()));
        hidden_input[1] = vector<vector<MatrixXd> >(s, vector<MatrixXd>(s, MatrixXd()));
        hidden_activate[0] = vector<vector<MatrixXd> >(s, vector<MatrixXd>(s, MatrixXd()));
        hidden_activate[1] = vector<vector<MatrixXd> >(s, vector<MatrixXd>(s, MatrixXd()));
        output_score[0] = vector<vector<MatrixXd> >(s, vector<MatrixXd>(s, MatrixXd()));
        output_score[1] = vector<vector<MatrixXd> >(s, vector<MatrixXd>(s, MatrixXd()));
    }
    ...
    vector<vector<MatrixXd> > hidden_input[2];
    vector<vector<MatrixXd> > hidden_activate[2];
    vector<vector<MatrixXd> > output_score[2];
    MatrixXd mask;
};
#endif
